# Ataraxia - Custom 50% Split Keyboard

### Description
Ataraxia is a wireless 52-key, 3D printed ergonomic keyboard desinged for a focused typing experience. The board is powered by dual Seeed Studio XIAO nRF52840 microcontrollers running ZMK firmware. 
It utilizes Bluetooth 5.0 to communicate seamlessly without a cable connecting the halves. The hardware stack includes a custom-routed printed circuit board, Kailh MX hotswap sockets, and direct-wired 
...
[Click here to view the full Bill of Materials (CSV)](<BOM/splitkeyBOM - Sheet1.csv>)
